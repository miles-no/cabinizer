...
export function registerHandlebarTemplates(): Templates {
  ...
  Handlebars.registerPartial(
    "exportInterface",
    Handlebars.template($exportInterface)
  );
  ...
  Handlebars.registerPartial(
    "schemaDictionary",
    Handlebars.template($schemaDictionary)
  );
  Handlebars.registerPartial("schemaEnum", Handlebars.template($schemaEnum));
  Handlebars.registerPartial(
    "schemaGeneric",
    Handlebars.template($schemaGeneric)
  );
  Handlebars.registerPartial(
    "schemaInterface",
    Handlebars.template($schemaInterface)
  );
  ...
  Handlebars.registerPartial(
    "typeDictionary",
    Handlebars.template($typeDictionary)
  );
  ...
  Handlebars.registerPartial(
    "typeReference",
    Handlebars.template($typeReference)
  );
